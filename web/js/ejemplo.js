...
function servicio_tr_html(id, nombres, descripcion) {
    var html = "<tr class='serv_" + id + "'>";
    html += "<td>" + nombres + "</td>";
    //html += "<td>" + descripcion + "</td>";
...
tabla_stock_add.$(".producto_16").find(".stock_cantidad").val()
$(tabla_stock_add.cell(20,2).node()).children().val()
tabla_stock_add.data().length